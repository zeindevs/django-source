...
from devices.schemas import DeviceCreateSchema, DeviceLocationPatch, DeviceSchema, Error, LocationSchema
...
@app.post('devices/', response={201: DeviceSchema, 404: Error})
